...
# restart to primary
restart_service $CANDIDATE_TRACKER_GO_INTERNAL_IP_PRIMARY
...
restart_service $CANDIDATE_TRACKER_GO_INTERNAL_IP_SECONDARY

echo "restart successful"

cleanup $CANDIDATE_TRACKER_GO_INTERNAL_IP_PRIMARY
cleanup $CANDIDATE_TRACKER_GO_INTERNAL_IP_SECONDARY
